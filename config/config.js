  ...
  "navigation": {
    ...
    "serviceLinks": [
      ...
      },
      {
        ...
        "route": "/services/device-management"
      },
      {
      ...
      },
      {
        ...
        "route": "/services/business-email-setup"
      },
      {
        "label": "Cloud Backup",
        "route": "/services/cloud-backup"
      },
      {
        "label": "Network & Wi-Fi Support",
        "route": "/services/network-wifi-support"
      },
      {
        "label": "Cybersecurity Basics",
        "route": "/services/cybersecurity-basics"
      },
      {
        "label": "IT Support Plans",
        "route": "/services/it-support-plans"
      },
      {
        "label": "Request Technical Support",
        "route": "/services/request-technical-support"
      }
    ]
  },
  "forms": {
    "endpoint": "/api/contact.php",
    "fromEmail": "website@steadydeskit.com",
    "serviceTypes": [
      "Remote IT Support",
      "Device Management",
      "Microsoft 365 Setup",
